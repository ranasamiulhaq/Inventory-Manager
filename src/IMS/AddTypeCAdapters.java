...
public class AddTypeCAdapters extends JFrame  {
    Container c;
    JLabel welcome_msg;
    ...
    public AddTypeCAdapters() {
        ...
        AddTypeCActionListener a = new AddTypeCActionListener();
    ...
    class AddTypeCActionListener implements ActionListener {
        @Override
            ...
            if (e.getActionCommand().equals("Back")) {
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        AdaptersRecord obj = new AdaptersRecord(id, "Type-C", price);
