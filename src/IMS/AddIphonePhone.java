...
public class AddIphonePhone extends JFrame  {
    Container c;
    JLabel welcome_msg;
    ...
    public AddIphonePhone() {
        ...
        AddIphonePhoneActionListener a = new AddIphonePhoneActionListener();
    ...
    class AddIphonePhoneActionListener implements ActionListener {
        @Override
            ...
            if (e.getActionCommand().equals("Back")) {
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        MobileRecord obj = new MobileRecord(id, "Iphone Phone", price);
