...
public class AddAndroidAdapters extends JFrame  {
    Container c;
    JLabel welcome_msg;
    ...
    public AddAndroidAdapters() {
        ...
        AddAndroidActionListener a = new AddAndroidActionListener();
    ...
    class AddAndroidActionListener implements ActionListener {
        @Override
            ...
            if (e.getActionCommand().equals("Back")) {
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        AdaptersRecord obj = new AdaptersRecord(id, "Android", price);
