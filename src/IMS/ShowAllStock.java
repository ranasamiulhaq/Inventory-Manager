...
public class ShowAllStock extends JFrame {
    Container c;
    JLabel welcome_msg;
    ...
    ShowAllStock() {
        ...
        ArrayList<CablesRecord> list1 = FileOperationsCables.showallstock();
        int count1=0;
        for (int i = 0; i < list1.size(); i++) {
            
            String str = "The Product ID is: " + list1.get(i).getProductID() + "\n" +
                    "The Cable type is: " + list1.get(i).CableType + "\n" +"The Price is: Rs " +list1.get(i).getPrice()+"\n"+
                    "-----------------------------------------------";
count1++;
        ...
        ArrayList<AdaptersRecord> list2 = FileOperationsAdapters.showallstock();
        int count2=0;
        for (int i = 0; i < list2.size(); i++) {
            
            String str = "The Product ID is: " + list2.get(i).getProductID() + "\n" +
                    "The Cable type is: " + list2.get(i).AdapterType + "\n" +"The Price is: Rs " +list2.get(i).getPrice()+"\n"+
                    "-----------------------------------------------";
            count2++;
            t1.append("\n" + str);
        ...
        t1.append("\n\n----------Mobiles-----------");
        ArrayList<AdaptersRecord> list3 = FileOperationsAdapters.showallstock();
        int count3=0;
        for (int i = 0; i < list3.size(); i++) {
            
            String str = "The Product ID is: " + list3.get(i).getProductID() + "\n" +
                    "The Cable type is: " + list3.get(i).AdapterType + "\n" +"The Price is: Rs " +list3.get(i).getPrice()+"\n"+
                    "-----------------------------------------------";
            count3++;
            t1.append("\n" + str);
        ...
        String quantity= Integer.toString(count1+count2+count3);
