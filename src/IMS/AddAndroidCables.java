...
public class AddAndroidCables extends JFrame implements Serializable {
    Container c;
    JLabel welcome_msg;
    ...
    public AddAndroidCables() {
        ...
        // Bracelets.setBounds(195, 470, 250, 50);
        // Bracelets.setFont(new Font("Saif", Font.BOLD, 30));
        // Bracelets.setForeground(java.awt.Color.black);
        // Bracelets.setBackground(java.awt.Color.ORANGE);
        ...
        c.add(Ok);
        c.add(Addmore);
        AddAndroidCablesListener a = new AddAndroidCablesListener();
    ...
    class AddAndroidCablesListener implements ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent e) {
          ...
          //      int ID_Len = ID.length();
            //    int Price_Length = Price.length();
                boolean allDigitsinID = onlydigits(ID, ID.length());
                boolean allDigitsinPrice = onlydigits(Price, Price.length());
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        CablesRecord obj = new CablesRecord(id, "Android", price);
