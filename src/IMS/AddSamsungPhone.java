...
public class AddSamsungPhone extends JFrame  {
    Container c;
    JLabel welcome_msg;
    ...
    public AddSamsungPhone() {
        ...
        AddSamsungPhoneActionListener a = new AddSamsungPhoneActionListener();
    ...
    class AddSamsungPhoneActionListener implements ActionListener {
        @Override
        public void actionPerformed(java.awt.event.ActionEvent e) {
            if (e.getActionCommand().equals("Back")) {
                ...
                ArrayList<MobileRecord> list = FileOperationsMobiles.showallstock();
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        MobileRecord obj = new MobileRecord(id, "Samsung Phone", price);
