...
public class AddThunderCables extends JFrame  {
    Container c;
    JLabel welcome_msg;
    ...
    public AddThunderCables() {
        ...
        AddThunderBoltActionListener a = new AddThunderBoltActionListener();
    ...
    class AddThunderBoltActionListener implements ActionListener {
        @Override
            ...
            if (e.getActionCommand().equals("Back")) {
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        CablesRecord obj = new CablesRecord(id, "Thunderbolt", price);
