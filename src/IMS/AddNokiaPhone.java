...
public class AddNokiaPhone extends JFrame  {
    Container c;
    JLabel welcome_msg;
    ...
    public AddNokiaPhone() {
        ...
        AddNokiaPhoneActionListener a = new AddNokiaPhoneActionListener();
    ...
    class AddNokiaPhoneActionListener implements ActionListener {
        @Override
            ...
            if (e.getActionCommand().equals("Back")) {
                ...
                if (allDigitsinID == true && allDigitsinPrice == false) {
                    ...
                    if (id_Check == 0) {
                        ...
                        MobileRecord obj = new MobileRecord(id, "Nokia Phone", price);
